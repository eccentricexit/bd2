...
CREATE TABLE Pedido (
    ...
    valor_total INTEGER (10, 2) NOT NULL, 
    data TEXT NOT NULL, 
    id_cliente_flc INTEGER REFERENCES cliente (id_cliente)
    );
...
INSERT INTO Pedido (id_pedido, valor_total, data, id_cliente_flc) VALUES (15, '33.5', '19/02/2016', 6);
...
CREATE TABLE ItemPedido (
    ...
    valor_sub_total INTEGER (10, 2) NOT NULL, 
    id_pedido_flc INTEGER (10) REFERENCES Pedido (id_pedido), 
    id_produto_flc INTEGER (10) REFERENCES Produto (id_produto)
    );
